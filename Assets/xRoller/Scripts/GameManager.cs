...
public class GameManager : MonoBehaviour
{
    ...
    public int gameRemainTime = 80;                             // Game Remain Time (Count Back From gameRemainTime)
    ...
    public static float WAYSPEED = -68f;    // Way Speed
    ...
    public GameObject uiPauseMenu;      // Game Pause Menu Canvas
    ...
    void Update()
    {
        ...
        if (SaveScript.isGameOver) { WAYSPEED = -68; wayMovePosition.z = -68; }
    ...
    void SetButtonListeners()
    {
        ...
        // Pause Menu
        uiPauseMenu.transform.GetChild(2).transform.GetComponent<Button>().onClick.AddListener(() => ShowHighScoreMenu(2));
        uiPauseMenu.transform.GetChild(3).transform.GetComponent<Button>().onClick.AddListener(() => ChangeSoundStatus());
    ...
    public void SetGameMusic()
    {
        ...
        if (gameSoundStatus == 0)
        {
            ...
            uiPauseMenu.transform.GetChild(3).transform.GetComponent<Image>().sprite = uiSoundSprites[gameSoundStatus];
